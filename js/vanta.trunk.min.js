    ...
    return function(e) {
        ...
        return i.m = e, i.c = t, i.d = function(e, t, s) {
            ...
            if (i.r(s), Object.defineProperty(s, "default", {
                ...
                for (var o in e) i.d(s, o, function(t) {
                    return e[t]
                }.bind(null, o));
            return s
        }, i.n = function(e) {
        ...
        1: function(e, t, i) {
            ...
            r.register = (e, t) => r[e] = e => new t(e), r.version = "0.5.11";
            const h = function() {
            ...
            r.VantaBase = class {
                constructor(e = {}) {
                    ...
                    if (this.options = Object(s.c)({
                            ...
                            el: e
                        }), Object(s.c)(this.options, e), this.options.THREE && (n = this.options.THREE), this.el = this.options.el, null == this.el) h('Instance needs "el" param!');
                    else if (!(this.options.el instanceof HTMLElement)) {
                        const e = this.el;
                        if (this.el = Object(s.f)(e), !this.el) return void h("Cannot find element", e)
                    }
                    this.prepareEl(), this.initThree(), this.setSize();
                    try {
                        this.init()
                    } catch (e) {
                        return h("Init error", e), this.renderer && this.renderer.domElement && this.el.removeChild(this.renderer.domElement), void(this.options.backgroundColor && (console.log("[VANTA] Falling back to backgroundColor"), this.el.style.background = Object(s.a)(this.options.backgroundColor)))
                    }
        ...
        15: function(e, t, i) {
            ...
            class r extends s.b {
                ...
                onInit() {
                    const e = this;
                    this.p5 = new n(function(t) {
                        let i = Object(o.e)() ? 10 : 25,
                            s = 100,
                            n = 5,
                            r = .03,
                            h = .09,
                        ...
                        function d(e, i, s) {
                            let o = e % t.TWO_PI;
                            return o < 0 && (o += t.TWO_PI), t.noise(c + t.cos(o) * i, u + t.sin(o) * i, l + s)
                        }
                        t.setup = function() {
                            e.initP5(t), t.strokeWeight(2), t.stroke(Object(o.a)(e.options.color)), t.smooth(), t.noFill()
                        }, t.draw = function() {
                            t.clear(), t.translate(t.width / 2, t.height / 2),
                                function() {
                                    ...
                                    for (let o = 0; o < i; o++) {
                                        ...
                                        for (let i = 0; i < 360; i++) {
                                            let c = t.radians(i),
                                                u = e.options.chaos * a * d(c, h * o + r, l) + (n * o + s) + (o * e.options.spacing || 0);
                                            t.vertex(u * t.cos(c), u * t.sin(c))
                                        }
                                        t.endShape(t.CLOSE)
                                    }
                                }()
            ...
            class r extends s.b {
                ...
                initP5(e) {
                    ...
                    i.parent(t.el), t.applyCanvasStyles(e.canvas, {
                        background: Object(o.a)(t.options.backgroundColor)
